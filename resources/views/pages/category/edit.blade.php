...
@section('content')
    ...
    <div class="conteiner">
        ...
        <form action="/category/{{$category->id }}" method="post" class="form-add">
            ...
            <input type="text" class="form-add__titel style__all" id="name" name="title" placeholder="Category name"
            ...
            <input type="text" class="form-add__titel style__all" id="slug" name="slug" placeholder="Category slug"
